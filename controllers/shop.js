...
exports.getProduct = (req, res, next) => {
    ...
    .catch(err => console.log("findById err from controllers/shop.js", err));
};
...
exports.getIndex = (req, res, next) => {
    Product.find() // find is a mongoose function that will find all our products automatically and puts them in an array.
        ...
        .then(products => {
            console.log("called from controllers/shop.js ", products); // shows us all the objects in the array products
...
exports.postCartDeleteProduct = (req, res, next) => {
    ...
    req.user
      ...
      .catch(err => console.log("err from postCartDeleteProduct in controllers/shop.js", err));
  };
  ...
  exports.postOrder = (req, res, next) => {
    ...
    .then(user => { // we're working with the full user to we have to call the user data to get our cart items.
      ...
      .catch(err => console.log("err from postOrder in controllers/shop.js", err));
  };

exports.getOrders = (req, res, next) => {
  // this looks for the 'user.userId' to be equal to 'req.user._id'. Basically finds all the orders for that userId.
