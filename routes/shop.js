...
router.post('/cart', shopController.postCart); // calls the postCart function from the shopController. All these router.post's do the same. They call a function from some controller.
